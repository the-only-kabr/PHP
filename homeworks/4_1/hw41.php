  ...
  <div class="w3-row-padding">
    ...
    <div class="w3-third">
      ...
      <div class="w3-white w3-text-grey w3-card-4">
        ...
        <div class="w3-container">
          ...
          <?php foreach ($skills as $key => $nav):?>
          <p><?=$nav['skill_name']?></p>
          <div class="w3-light-grey w3-round-xlarge w3-small">
            <div class="w3-container w3-center w3-round-xlarge w3-teal" style="width:<?=$nav['level']?>%"><?=$nav['level']?>%</div>
          </div>
          <?php endforeach;?>
          <br>
    ...
    <div class="w3-twothird">
      ...
      <div class="w3-container w3-card w3-white w3-margin-bottom">
        ...
        <?php foreach ($expirience as $key => $exp): ?>
          <div class="w3-container">
          <h5 class="w3-opacity"><b><?=$exp['position']?> </b></h5>
          <h6 class="w3-text-teal"><i class="fa fa-calendar fa-fw w3-margin-right"></i><?=$exp['period']?><?php if ($key== 0):?>
